...
export const clientSlice = createSlice({
  ...
  reducers: {
    setClient: (state, action: PayloadAction<ClientInterface>) => {
      ...
      state.clientGuestId = action.payload.clientGuestId;
      state.email = action.payload.email;
      state.name = action.payload.name;
      state.surname = action.payload.surname;
      state.identityDocument = action.payload.identityDocument;
    ...
    unsetClient: (state) => {
      ...
      state.clientGuestId = undefined;
      state.email = undefined;
      state.name = undefined;
      state.surname = undefined;
      state.identityDocument = undefined;
